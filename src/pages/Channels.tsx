  ...
  const fetchChannels = async () => {
    ...
    try {
      ...
      const customStaticChannels: Channel[] = [
        { id: "bein-1", name: "beIN SPORTS 1", url: "https://vidsrc.xyz/embed/movie/tt0000001", category: "الرياضة", logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/beIN_Sports_1_logo.svg/1200px-beIN_Sports_1_logo.svg.png" },
        { id: "bein-2", name: "beIN SPORTS 2", url: "https://vidsrc.xyz/embed/movie/tt0000002", category: "الرياضة", logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/beIN_Sports_2_logo.svg/1200px-beIN_Sports_2_logo.svg.png" },
        { id: "bein-3", name: "beIN SPORTS 3", url: "https://vidsrc.xyz/embed/movie/tt0000003", category: "الرياضة", logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/beIN_Sports_3_logo.svg/1200px-beIN_Sports_3_logo.svg.png" },
        { id: "bein-4", name: "beIN SPORTS 4", url: "https://vidsrc.xyz/embed/movie/tt0000004", category: "الرياضة", logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/beIN_Sports_4_logo.svg/1200px-beIN_Sports_4_logo.svg.png" },
        { id: "bein-news", name: "beIN SPORTS NEWS", url: "https://beinsports-news.akamaized.net/hls/live/2000341/test/master.m3u8", category: "الرياضة", logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/BeIN_Sports_News_logo.svg/1200px-BeIN_Sports_News_logo.svg.png" },
