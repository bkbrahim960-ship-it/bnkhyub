...
export const VideoPlayer = forwardRef<VideoPlayerRef, Props>(({
  ...
  const vaplayerUrl = type === "movie"
    ? `https://vaplayer.ru/embed/movie/${imdb_id || tmdb_id}?color=%23C124A0&lang=ar&sub=ar&noads=1`
    : `https://vaplayer.ru/embed/tv/${imdb_id || tmdb_id}/${season}/${episode}?color=%23C124A0&lang=ar&sub=ar&noads=1`;
